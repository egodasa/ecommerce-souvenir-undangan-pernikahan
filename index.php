...
$daftarProduk = $db->sql('select * from tbl_produk a join tbl_foto_produk b on a.id_produk = b.id_produk group by b.id_produk,a.id_produk')->limit(4)->offset($offset)->many();
